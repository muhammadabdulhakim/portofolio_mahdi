    ...
    <script>
        $(document).ready(function() {
            $('#sample_form').on('submit', function(event) {
                ...
                $.ajax({
                    url: "https://mabdulhakim24.amisbudi.cloud/portofolio-mahdi/si-admin/api/auth/login.php",
                    method: "POST",
                    data: JSON.stringify(formData),
                    success: function(data) {
                        $('#action_button').attr('disabled', false);
                        window.location.href = 'https://mabdulhakim24.amisbudi.cloud/portofolio-mahdi/';
                    },
                    error: function(err) {
                        console.log(err);
