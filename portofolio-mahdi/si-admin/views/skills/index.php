    ...
    <script>
        $(document).ready(function() {
            ...
            $('#sample_form').on('submit', function(event) {
                ...
                if ($('#action').val() == "Add") {
                    ...
                    $.ajax({
                        url: "https://mabdulhakim24.amisbudi.cloud/portofolio-mahdi/si-admin/api/skills/create.php",
                        method: "POST",
                    ...
                    $.ajax({
                        url: "https://mabdulhakim24.amisbudi.cloud/portofolio-mahdi/si-admin/api/skills/update.php",
                        method: "PUT",
                        data: JSON.stringify(formData),
                        success: function(data) {
                            $('#action_button').attr('disabled', false);
        ...
        function showAll() {
            $.ajax({
                ...
                url: "https://mabdulhakim24.amisbudi.cloud/portofolio-mahdi/si-admin/api/skills/read.php",
        ...
        function showOne(id) {
            ...
            $.ajax({
                type: "GET",
                contentType: "application/json",
                url: "https://mabdulhakim24.amisbudi.cloud/portofolio-mahdi/si-admin/api/skills/read.php?id=" + id,
                success: function(response) {
                    $('#id').val(response.id);
        ...
        function deleteOne(id) {
            ...
            if (konfirmasiUser) {
                $.ajax({
                    url: "https://mabdulhakim24.amisbudi.cloud/portofolio-mahdi/si-admin/api/skills/delete.php",
                    method: "DELETE",
                    data: JSON.stringify({
                        id: id,
                    }),
